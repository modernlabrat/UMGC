...
public class Project1{
  ...
  private void getFile() {
    ...
    try {
      ...
      System.out.println("\tSucess: Retrieved File");
        ...
        for( String token : preTokens ) {
          if (isString) {
            ...
            if (token.equals("\"")) {
              ...
              System.out.println("\t\t\tToken " + tokenCount + ": " + text.trim());
              text = "";
  ...
  public void parseGUI() {
    ...
    System.out.println("\n\tFailed: Cannot Parse GUI. Token " + currentTokenKey + ": " + currentToken() + " Incorrect Syntax. View Log.");
    System.exit(0);
  }
      ...
      if(currentToken().equals("(")) { // Grid (NUMBER, NUMBER)
        ...
        if(currentToken().equals(",")) {
          ...
          if(currentToken().equals(")")) {
            ...
            System.out.println("\t\t\tTest (1/1): Parse and Set GridLayout(ROW, COLUMN, ROW_SPACING, COLUMN_SPACING)");
            getNextToken();
            ...
            if (currentToken().equals(",")) {
              ...
              if(currentToken().equals(")")) {
                ...
                getNextToken();
                System.out.println("\t\t\t\tSuccess: Parsed GridLayout(ROWS,COLUMNS,COLUMN_SPACING,ROW_SPACING)");
                System.out.println("\t\t\t\tSucess: Parse LayoutType");
                return true;
              }
            }
  ...
  // currentToken() returns the value of in the LinkedHashMap based on the currentTokenKey

  private String currentToken() {
    return tokens.get(currentTokenKey);
  }
